...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About SinghBouncers — Discipline, Discretion, Trust" },
      { name: "description", content: "Veteran-led, ISO 9001 certified private security firm protecting enterprises, estates and events for nearly two decades." },
      { property: "og:title", content: "About SinghBouncers" },
    ...
    <>
      <section className="bg-hero-radial py-20 lg:py-28 border-b border-border/60">
        <div className="container-x text-center">
          ...
          <p className="mt-5 max-w-2xl mx-auto text-muted-foreground">Founded in 2007 by a small team of veteran protective Security Personals, SinghBouncers has grown into a national security firm known for one thing above all: Security Personals you can trust.</p>
        </div>
      </section>
